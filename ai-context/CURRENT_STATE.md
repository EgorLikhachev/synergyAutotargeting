...
3. ~~Безопасность: WatchdogSec+sd_notify, токен канала~~ — закрыто
   2026-09-08 (ADR-019/020, проверено на борту). Токен на борту ВЫКЛЮЧЕН
   (пусто) — включить: [control] token + env SYNERGY_TOKEN пульту.
